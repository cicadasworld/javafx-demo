...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        PathTransition pathTransition = MyRectangle.build(startX, startY, pathStrokeWidth);
        ...
        myGroup.getChildren().addAll(pathTransition.getPath(), startLine, pathTransition.getNode());
